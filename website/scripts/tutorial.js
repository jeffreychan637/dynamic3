...
window.onload = function() {
    ...
    function loopWithRandomDynamicData() {
        ...
        setTimeout(loopWithRandomDynamicData, waitTime) //In order to simulate the data coming in, we call this function over and over again after a random amount of seconds each time.
